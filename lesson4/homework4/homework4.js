...
//5:
// let products = [
//     { id: 1, Name: 'Xiaomi portable charger 20000mah', Brand: 'Xiaomi', Price: 428, Color:'White', Category:'Charger' },
...
//     console.log(`    Price: ${x.Price}`);
// }
// let number = prompt("Enter product position:")
// for (let x of products) {
//     if (x.id == number) {
//         console.log(x);
//     }
...
// 5.5
// let answer=prompt("Enter provider")
// for(let x of products){
//     let check=x.Providers.indexOf(answer)
//     if(check==-1){
//         console.log('-------------------------------');
...
//     {name:'Bacsics of Javascript',Complete: 'false'},
//     {name:'Node Package Manager (npm)',Complete: 'false'},
//     {name:'Git',Complete: 'false'}
// ]
// for(let x in script){
//     console.log(`${Number(x)+1}. ${script[x].name} \n   Complete: ${script[x].Complete}`);
// }

// while (true) {
//     let newtask = prompt("Enter your command (New, Delete, Update, Complete)")
//     if (newtask == 'New') {
//         let a = prompt("Enter new task")
//         let newname = { name: a, Complete: 'false' }
//         script.push(newname)
//         for (let x in script) {
//             console.log(`${Number(x) + 1}. ${script[x].name} \n   Complete: ${script[x].Complete}`);
//         }
//     }
//     else if(newtask=='Update'){
//         let position=prompt("Enter position")
//         let title=prompt("Enter new title")
//         script[position-1].name=title
//         for (let x in script) {
//             console.log(`${Number(x) + 1}. ${script[x].name} \n   Complete: ${script[x].Complete}`);
//         }
//     }
//     else if (newtask=='Complete'){
//         let position=prompt("Enter position")
//         script[position-1].Complete="true"
//         for (let x in script) {
//             console.log(`${Number(x) + 1}. ${script[x].name} \n   Complete: ${script[x].Complete}`);
//         }
//     }
//     else if(newtask=='Delete'){
//         let position=prompt("Enter position")
//         script.splice(position-1,1)
//         for (let x in script) {
//             console.log(`${Number(x) + 1}. ${script[x].name} \n   Complete: ${script[x].Complete}`);
//         }
//     }
...
// for(let items of jobData.hits[0].benefits){
//     console.log(`- ${items.benefitValue}`);
// }
// // 15.6:
// console.log('-----------------------------');
// for(let obj of jobData.hits){
//     console.log(obj.jobTitle);
//     console.log('Benefits:');
//     for(let items of obj.benefits){
//         console.log(`- ${items.benefitValue}`);
//     }
//     console.log('---------------------------------------');
// }
...
//     console.log(`Location: ${obj.locations}`);
//     console.log(`Benefits:`);
//     for(let benefit of obj.benefits){
